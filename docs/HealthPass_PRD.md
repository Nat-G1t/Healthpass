...
- **BR-16** `result` (Fit/Unfit) is required to save; case category and purpose are optional. An **Others** purpose additionally requires its specify-event text (D-24).
