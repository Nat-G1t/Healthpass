<x-layout.sidebar title="Director Dashboard">
    ...
    <div class="mb-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <x-hp.card class="border-l-4 border-l-hp-orange">
            ...
            <p class="mt-3 text-3xl font-bold leading-none text-hp-orange">{{ $stats['clearances'] }}</p>
        ...
        <x-hp.card>
            ...
            <p class="mt-3 text-3xl font-bold leading-none text-hp-slate">{{ $stats['pendingBatches'] }}</p>
        ...
        <x-hp.card>
            ...
            <p class="mt-3 text-3xl font-bold leading-none text-hp-slate">{{ $stats['todaysAppointments'] }}</p>
        ...
        <x-hp.card>
            ...
            <p class="mt-3 text-3xl font-bold leading-none text-hp-slate">{{ $stats['flaggedVisits'] }}</p>
