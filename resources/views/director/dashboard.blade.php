<x-layout.sidebar title="Director Dashboard">
    ...
    <div class="hp-stagger mb-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <x-hp.card class="border-l-4 border-l-hp-orange">
            ...
            <p class="mt-2 text-xs text-hp-slate/50 dark:text-hp-slate/60">all encoded results</p>
        </x-hp.card>
        ...
        <x-hp.card>
            ...
            <p class="mt-2 text-xs text-hp-slate/50 dark:text-hp-slate/60">awaiting your decision</p>
        </x-hp.card>
                ...
                <div class="divide-y divide-hp-slate/10">
                    @foreach ($flaggedVisits as $visit)
                        <div class="flex items-center justify-between gap-4 py-3">
                            ...
                            <span class="shrink-0 text-xs text-hp-slate/50 dark:text-hp-slate/60">
                                {{ $visit->college->code ?? '—' }}
                            </span>
                        </div>
                    @endforeach
