<x-register.wizard-shell :step="4">
    ...
    >
        ...
        <div
            x-show="mode === 'error'"
            class="mb-4 rounded-lg border border-red-200 dark:border-red-500/30 bg-red-50 dark:bg-red-500/10 px-4 py-3 text-sm text-red-700 dark:text-red-300"
        >
        ...
        <div x-show="mode === 'idle'" class="mb-6 grid grid-cols-2 gap-3">
            ...
            <button
                ...
                class="flex flex-col items-center gap-3 rounded-xl border-2 border-hp-peach
                       bg-hp-white px-4 py-5 text-sm font-semibold text-hp-slate transition-colors
        ...
        <div x-show="mode === 'matched'" class="mb-6">
            <div class="mb-4 flex items-center gap-3 rounded-xl border border-green-200 dark:border-green-500/30 bg-green-50 dark:bg-green-500/10 px-4 py-3">
                ...
                <div>
                    <p class="text-sm font-semibold text-green-800 dark:text-green-200">QR code matched</p>
                    <p class="text-xs text-green-700 dark:text-green-300">IDNo: <span x-text="matchedId"></span></p>
                </div>
            </div>
        ...
        @if (app()->isLocal())
            <div class="mb-6 rounded-lg border border-dashed border-slate-300 dark:border-hp-slate/25 bg-slate-50 dark:bg-hp-white px-4 py-3">
                <p class="mb-2 text-xs font-semibold text-slate-500 dark:text-hp-slate/60">Dev: paste IDNo (no camera needed)</p>
                <div class="flex gap-2">
                    <input
                        ...
                        class="min-w-0 flex-1 rounded-lg border border-slate-300 dark:border-hp-slate/25 px-3 py-2 text-sm text-hp-slate
                    ...
                    <button
                        ...
                        class="shrink-0 rounded-lg bg-slate-600 px-4 py-2 text-sm font-semibold text-white
                               hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:dark:ring-hp-slate/40/40"
                    >
                        Submit
                    </button>
                </div>
        ...
        <p class="mt-3 text-center text-xs text-hp-slate/50 dark:text-hp-slate/60">
